...
.controller('AppCtrl', ['$scope', '$window', '$ionicPopup', 'SharedVars',
  ...
  $scope.createPromo = function(promo) {
    //Se recupera el título de la promoción
    var title = promo.title;

    //Se recupera la descripción de la promoción
    ...
    var sendPromoPromise = PromoService.sendPromo(promo);
